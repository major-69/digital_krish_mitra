...
import digi.coders.digitalkrishimitraa.Activity.Apply_Job_Activity;
...
//        // External sdcard location
        File mediaStorageDir = new File(
                ...
                Apply_Job_Activity.GALLERY_DIRECTORY_NAME);

        // Create the storage directory if it does not exist
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                Log.e(Apply_Job_Activity.GALLERY_DIRECTORY_NAME, "Oops! Failed create "
                        + Apply_Job_Activity.GALLERY_DIRECTORY_NAME + " directory");
                return null;
            }
        }
        ...
        File mediaFile;
        if (type == Apply_Job_Activity.MEDIA_TYPE_PDF) {
    ...
    public static File getOutputMediaFilePDF(int type) {
