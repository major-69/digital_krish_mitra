...
import digi.coders.digitalkrishimitraa.databinding.FragmentDonationBinding;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class Donation_Fragment extends Fragment implements Refresh {
    ...
    public void donation(){
        ...
        progressDialog.show();
        RetrofitClient.getClient().fundraise(userid).enqueue(new Callback<JsonArray>() {
            @Override
            public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
                try {
                    ...
                    if (result.equalsIgnoreCase("success")) {
                        ...
                        Donation_Adapter adapter = new Donation_Adapter(getContext(),postModelArrayList,Donation_Fragment.this);
