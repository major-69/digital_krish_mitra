...
import digi.coders.digitalkrishimitraa.databinding.FragmentJobseekerBinding;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class Jobseeker_Fragment extends Fragment implements Refresh {


    FragmentJobseekerBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding= FragmentJobseekerBinding.inflate(inflater,container,false);
...
//        Jobseeker_Adapter adapter = new Jobseeker_Adapter(getContext());
...
//        binding.recycler.setLayoutManager(new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false));
    ...
    public void jobs(){
        ...
        progressDialog.show();
        RetrofitClient.getClient().alljobs(userid).enqueue(new Callback<JsonArray>() {
            @Override
            public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
                try {
                    Log.d("jobseeker234", "onResponse: "+response.body().toString());
                    ...
                    if (result.equalsIgnoreCase("success")) {
                        ...
                        Jobseeker_Adapter adapter = new Jobseeker_Adapter(getContext(),postModelArrayList,Jobseeker_Fragment.this);
                        binding.recycler.setAdapter(adapter);
                        binding.recycler.setLayoutManager(new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false));
